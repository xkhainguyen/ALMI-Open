...
#     flag_list.append({})
# joblib.dump(flag_list, "./select_data_process/data_list.pkl")
# 1/0
...
with open("./mujoco/frame_text.csv", "r", encoding="utf-8") as file:
...
with mujoco.viewer.launch_passive(m, d) as viewer:
    ...
    while True:
        ...
        write_specific_row("./mujoco/frame_text.csv", i+1, [start_frame, end_frame, new_text])
