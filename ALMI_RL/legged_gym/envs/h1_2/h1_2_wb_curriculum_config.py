...
class H1_2_WholeBodyCfg(LeggedRobotCfg):
    ...
    class env(LeggedRobotCfg.env):
        ...
        single_step_obs = 60 # no command and phase
        single_step_obs_priv = 63 # no command and phase

        num_observations_add_history = num_observations + history_length * single_step_obs
        num_privileged_obs_add_history = num_privileged_obs + history_length * single_step_obs_priv
...
class H1_2_WholeBodyCfgPPO(LeggedRobotCfgPPO):
    ...
    class runner( LeggedRobotCfgPPO.runner ):
        ...
        save_interval = 100
        run_name = ''
        experiment_name = 'h1_2_wb_curriculum'